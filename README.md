...
## Project Description
#### Developed a personal portfolio website to showcase professional skills, projects, education and experiences to potential employers and clients. The site includes detailed sections such as Home, About Me, Services, Portfolio, and Contact.
...
### Outcome
- Successfully created a professional online presence that effectively showcases skills and projects.
- Received positive feedback from peers.
I- ncreased visibility and engagement through improved SEO and user-friendly design.
...
```html
<script>
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzAxObVxnCRwmmWSaUPZq8XuQY5Q7dO2YSS6BIkURj4izYMVFvsZmNzY7-RHJimMkHTIw/exec'
    const form = document.forms['submit-to-google-sheet']
